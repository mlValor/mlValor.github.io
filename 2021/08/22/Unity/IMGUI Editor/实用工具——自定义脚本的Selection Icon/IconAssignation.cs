...
{
	public class IconAssignation: EditorWindow 
	{
		
		[MenuItem("Editor Extension/Icon Assignation", priority = 4)]
		static void Init()
		{
			EditorWindow.GetWindow<IconAssignation> (true, "Icon Assigner").Show ();
		}
		...
		public void OnGUI()
		{
			...
			if (icon == null)
				...
				var pos = EditorGUILayout.GetControlRect (false, iconMaxSize);
